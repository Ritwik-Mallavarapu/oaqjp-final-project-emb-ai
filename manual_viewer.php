...
$type = $_GET['type'] ?? 'manual'; // Though this page is specific to manuals
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Manual: <?php echo htmlspecialchars($model); ?> - Dad and Dude Repair</title>
...
<body>
    ...
    <div class="container">
        <h2>Viewing Manual for: <?php echo htmlspecialchars($model); ?></h2>
        <p>This is a placeholder for the <?php echo htmlspecialchars($model); ?> manual content. Actual manual content will be loaded here from the database or file system in a future update.</p>
        {/* Actual manual content (e.g., embedded PDF, text, images) will go here */}
